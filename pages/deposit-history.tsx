...
class DepositHistory extends Component<Props, State> {
            ...
            <React.Fragment>
                ...
                <div className={cx('container py-[10px] sm:py-[40px] px-4')}>
                    <div>
                            ...
                            <TransactionHistory className='mt-10' heading="Deposit History" href="withdraw-history" buttonLabel="Withdraw History"/>
                    </div>
                </div>
                <Footer/>
            </React.Fragment>
